...
class SubstancesScreen extends StatefulWidget {
  ...
  static const routeName = '/substance';
...
class _SubstancesScreenState extends State<SubstancesScreen> {
  ...
  _loadData() async {
    ...
    String? savedPotencies = prefs.getString('substances');
  ...
  _saveData() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setString('substances', _potencies.toString());
  }
        ...
        children: [
          ListTile(
            contentPadding: const EdgeInsets.symmetric(
                horizontal: 15.0,
                vertical: 0), // Adjust padding to reduce space
            title: Text(key,
                style:
    ...
    showCupertinoDialog(
      ...
      builder: (BuildContext context) {
        return CupertinoAlertDialog(
          title:  Text(S.of(context).addNewSubstances),
          content: Column(
            ...
            children: <Widget>[
              ...
              CupertinoTextField(
                ...
                placeholder: S.of(context).enterSubstanceName,
                padding:
              ...
              CupertinoTextField(
                ...
                placeholder: S.of(context).enterSubstanceSequence,
                padding:
                    const EdgeInsets.symmetric(horizontal: 12, vertical: 10),
                style: const TextStyle(fontSize: 18),
              ),
